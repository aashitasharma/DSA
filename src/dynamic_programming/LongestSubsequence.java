...
public class LongestSubsequence {
	...
	/**
	 * Longest increasing subsequence naive O(n^2) Follow Up Design an algorithm
	 * to construct the longest increasing list. Also, model your solution using
	 * DAGs.
	 * 
	...
	/**
	 * House Robber Problem Recursive equation: money[i]=max(a[i]+money[i-2],
	 * money[i-1]);
	 * 
	 * @param args
	 */
